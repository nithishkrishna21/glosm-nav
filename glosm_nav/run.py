...
import glosm_nav.measurements.traveled_stairs  # noqa: F401
import glosm_nav.obs_transformers.resize  # noqa: F401
import glosm_nav.policy.action_replay_policy  # noqa: F401
import glosm_nav.policy.habitat_policies  # noqa: F401
import glosm_nav.utils.vlfm_trainer  # noqa: F401
...
def main(cfg: DictConfig) -> None:
    ...
    if not os.path.isfile("data/dummy_policy.pth"):
        ...
        print("python -m glosm_nav.utils.generate_dummy_policy")
        exit(1)
