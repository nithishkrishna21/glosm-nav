    ...
    def __init__(
        ...
        try:
            from groundingdino.util.inference import load_model, predict
             ...
             raise ModuleNotFoundError("Could not import groundingdino. Make sure it is installed if running the server.")
             
        self.load_model = load_model
        self.predict_fn = predict
        
        self.model = self.load_model(model_config_path=config_path, model_checkpoint_path=weights_path).to(device)
