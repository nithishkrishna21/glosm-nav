...
from glosm_nav.semexp_env.semexp_policy import SemExpITMPolicyV2, SemExpITMPolicyV3
from glosm_nav.utils.img_utils import reorient_rescale_map, resize_images
from glosm_nav.utils.log_saver import is_evaluated, log_episode
from glosm_nav.utils.visualization import add_text_to_image
...
args.split = "val"
args.task_config = "objnav_gibson_glosm_nav.yaml"
